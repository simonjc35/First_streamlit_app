...
# write your own comment -what does the next line do? - take json text and normilses it 
...
add_my_fruit = fruit_choice = streamlit.text_input('What fruit would you like to add?','Kiwi')
